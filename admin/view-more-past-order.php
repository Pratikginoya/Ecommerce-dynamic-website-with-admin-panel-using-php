          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Status of Past Orders</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <table id="example2" class="table table-bordered">
                  ...
                  <?php if($row['status']=='Delivered' || $row['status']=='Cancelled-By-Supplier') { ?>
                    <a href="edit-past-order-status.php?e_id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit Order Status</a>
                  <?php } ?>
                  <br>
                  <a href="view-all-orders.php" class="btn btn-primary">Back to View Past Orders List</a>
