						...
						<div class="flex-l-m flex-w w-full p-t-10 m-lr--7">
							...
							if (isset($_GET['search'])) {
								...
								for ($i=1; $i<=$page_count_s; $i++) { ?>
									<a href="javascript:void(0)" class="flex-c-m how-pagination1 trans-04 m-all-7 active-pagination1 page_change_s" attr_id=<?php echo $i; ?>>
									<?php echo $i; ?>
									</a>
								<?php } 
							}
								...
								for ($i=1; $i<=$page_count; $i++) { ?>
									<a href="javascript:void(0)" class="flex-c-m how-pagination1 trans-04 m-all-7 active-pagination1 page_change" attr_id=<?php echo $i; ?>>
									<?php echo $i; ?>
									</a>
							 	<?php } 
							 }?>
